...
<template>
    <!------------------------------ 중단 메인 이미지 부분 ------------------------------------->
    <div class="sub-visual" style="background-image: url(https://jihoosoft.com/assets/images/sub/visual_5.jpg)">
    ...
    <main class="main py-15 py-lg-20" id="contents">
      <section class="section">
        <div class="container">
          <form name="signform" id="signform" method="post" action="/Bboard/jehuok.php" enctype="multipart/form-data" onsubmit="return submitcheck()">
            <div class="form_wrap type_b">
              ...
              <ul class="clause_list">
                <li>
                    ...
                    <div class="agree_box mt_10">
                        <input type="checkbox" name="yark" value="1" id="yark" title="개인정보처리방침에 동의" class="mr_05" required1="">
              ...
              <div class="board_btn_bx text_center mt_30">
                <button type="submit" class="btn-type-01">문의하기</button>
              </div>
            </div>
          </form>
        </div>
